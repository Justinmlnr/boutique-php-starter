...
<main class="main-content">
    <div class="container">
        ...
        <!-- ============================================
             BREADCRUMB
             JOUR 6 : Générer dynamiquement avec $_GET['id']
             ============================================ -->
        <nav class="breadcrumb">
            ...
            <a href="catalogue.html?category=vetements">Vêtements</a>
            <span>/</span>
        ...
        <!-- ============================================
             DÉTAIL PRODUIT
             JOUR 6 : Récupérer produit via $_GET['id']
        ...
        <div class="product-detail">
            ...
            <div class="product-detail__info">
                ...
                <!-- JOUR 6 : <?= htmlspecialchars($product['category']) ?> -->
                <span class="product-detail__category">Vêtements</span>
                ...
                <div class="product-detail__price">
                    ...
                    <span class="product-detail__price-current">35,99 €</span>
                    <!-- JOUR 4 : Si promo, afficher ancien prix -->
                    <!-- <span class="product-detail__price-old">45,99 €</span> -->
                </div>

                <!-- JOUR 6 : <?= htmlspecialchars($product['description']) ?> -->
                <p class="product-detail__description">
                    T-shirt en coton biologique de haute qualité. Coupe moderne et confortable,
...
<script>
// Scripts simples pour la démo (seront remplacés par PHP)
