                        ...
                        <div class="catalog-sidebar__section">
                            ...
                            <div class="catalog-sidebar__price-inputs">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price_max" class="form-input" placeholder="100 €"
                                        min="0">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="products-grid">
                        ...
                        <article class="product-card">
                            <div class="product-card__image-wrapper">
                                <img src="https://via.placeholder.com/300x300/e2e8f0/64748b?text=T-shirt" alt="T-shirt"
                            ...
                            <div class="product-card__content">
                                ...
                                <div class="product-card__price"><span class="product-card__price-current">35,99
                                        €</span></div>
                        ...
                        <article class="product-card">
                            <div class="product-card__image-wrapper">
                                <img src="https://via.placeholder.com/300x300/e2e8f0/64748b?text=Sneakers"
                                    alt="Sneakers" class="product-card__image">
                        ...
                        <article class="product-card">
                            <div class="product-card__image-wrapper">
                                <img src="https://via.placeholder.com/300x300/e2e8f0/64748b?text=Casquette"
                                    alt="Casquette" class="product-card__image">
                            ...
                            <div class="product-card__content">
                                ...
                                <div class="product-card__price"><span class="product-card__price-current">24,99
                                        €</span></div>
                        ...
                        <article class="product-card">
                            <div class="product-card__image-wrapper">
                                <img src="https://via.placeholder.com/300x300/e2e8f0/64748b?text=Jean" alt="Jean"
                                    class="product-card__image">
                        ...
                        <article class="product-card">
                            <div class="product-card__image-wrapper">
                                <img src="https://via.placeholder.com/300x300/e2e8f0/64748b?text=Sac" alt="Sac"
                                    class="product-card__image">
                                <div class="product-card__badges"><span class="badge badge--new">Nouveau</span></div>
                            </div>
                            <div class="product-card__content">
                                ...
                                <div class="product-card__price"><span class="product-card__price-current">59,99
                                        €</span></div>
                        ...
                        <article class="product-card">
                            <div class="product-card__image-wrapper">
                                <img src="https://via.placeholder.com/300x300/e2e8f0/64748b?text=Montre" alt="Montre"
                                    class="product-card__image">
                                <div class="product-card__badges"><span class="badge badge--out-of-stock">Rupture</span>
                                </div>
                            </div>
                            <div class="product-card__content">
                                <span class="product-card__category">Accessoires</span>
                                <a href="produit.html?id=6" class="product-card__title">Montre Classic</a>
                                <div class="product-card__price"><span class="product-card__price-current">89,99
                                        €</span></div>
                        ...
                        <article class="product-card">
                            <div class="product-card__image-wrapper">
                                <img src="https://via.placeholder.com/300x300/e2e8f0/64748b?text=Pull" alt="Pull"
                                    class="product-card__image">
                                <div class="product-card__badges"></div>
                            </div>
                            <div class="product-card__content">
                                ...
                                <div class="product-card__price"><span class="product-card__price-current">49,99
                                        €</span></div>
                        ...
                        <article class="product-card">
                            <div class="product-card__image-wrapper">
                                <img src="https://via.placeholder.com/300x300/e2e8f0/64748b?text=Ceinture"
                                    alt="Ceinture" class="product-card__image">
                                <div class="product-card__badges"><span class="badge badge--out-of-stock">Rupture</span>
                                </div>
                            </div>
                            <div class="product-card__content">
                                ...
                                <div class="product-card__price"><span class="product-card__price-current">34,99
                                        €</span></div>
                                <p class="product-card__stock product-card__stock--out">✗ Rupture</p>
                                <div class="product-card__actions">
                                    <button class="btn btn--secondary btn--block" disabled>Indisponible</button>
                        ...
                        $products = [
                            [
                                ...
                                "category" => "Vêtements",
                                "price" => "99,99 €",
                                "image" => "https://via.placeholder.com/300x300/e2e8f0/64748b?text=Ceinture",
                                "stock" => 0
                            ],
                            [
                                "id" => 10,
                                ...
                                "category" => "Vêtements",
                                "price" => "45,99 €",
                                "image" => "https://via.placeholder.com/300x300/e2e8f0/64748b?text=Montre",
                                "stock" => 5
                            ],
                            [
                                "id" => 11,
                                ...
                                "category" => "Vêtements",
                                "price" => "150,99 €",
                                "image" => "https://via.placeholder.com/300x300/e2e8f0/64748b?text=Casquette",
                                "stock" => 15
                            ],
                            [
                                "id" => 12,
                                ...
                                "category" => "Vêtements",
                                "price" => "30,90 €",
                                "image" => "https://via.placeholder.com/300x300/e2e8f0/64748b?text=Sac+à+dos",
                                "stock" => 2
                            ],
                            [
                                "id" => 13,
                                ...
                                "category" => "Vêtements",
                                "price" => "90,99 €",
                                "image" => "https://via.placeholder.com/300x300/e2e8f0/64748b?text=Portefeuille",
                                "stock" => 0
                            ],
                            [
                                "id" => 14,
                                ...
                                "category" => "Vêtements",
                                "price" => "120,99 €",
                                "image" => "https://via.placeholder.com/300x300/e2e8f0/64748b?text=Lunettes",
                                "stock" => 8
                            ],
                        ];
                        ...
                        foreach ($products as $p):
                            ...
                            <article class="product-card">
                                ...
                                <div class="product-card__content">
                                    ...
                                    <a href="produit.html?id=<?= $p['id']; ?>" class="product-card__title">
                                        <?= $p['name']; ?>
                                    </a>
                                    ...
                                    <?php if ($p['stock'] > 0): ?>
                                        <p class="product-card__stock product-card__stock--in">✓ En stock (<?= $p['stock']; ?>)
                                        </p>
                                        <div class="product-card__actions">
                                            <button class="btn btn--primary btn--block">Ajouter au panier</button>
                                        </div>
                                    <?php else: ?>
                                        <p class="product-card__stock product-card__stock--out">✗ Rupture</p>
                                        <div class="product-card__actions">
